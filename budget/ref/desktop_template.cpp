...
/**
 * @brief This is a solution provided by author for reference
 * It supports Earn/Spend/Total amount requests as variable
 * tax pay request parsing
 */
